...
public class Ueb17{
     ...
     * @param int j groeﬂter Wert der getestet wird.
    ...
    public void run()
    {
        ...
        //
        //1.f
        System.out.println( "\n Test factorial f(x) = even \n");
        applyAndPrint(  1, 10,  condiFactorial.conditionateOutput(even));
    }
    ...
    public static void main(String[] args){
        ...
        Ueb17 tester = new Ueb17();
        tester.start();

        Ueb17 testEvenOdd = new Ueb17();
        testEvenOdd.run();
    }
