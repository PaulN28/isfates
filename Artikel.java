...
public class Artikel
{
 ...
 public Artikel(int artikelnummer, String artikelbezeichnung)
  ...
  /**
   * Prüft ob die Bedingung (zB, dass die Artikelnummer 4-stellig sein muss,...) erfüllt wurde, wenn nicht, wirft eine IllegalArgumentException und bricht das Programm ab
   */
