...
public class TimeTest
{
    ...
    private boolean ergIterative;
    private boolean ergRecursive;
    ...
    public double runIterativeFunction(String teststring){
        ...
        boolean ergIterative = PalindromeIterative.isPalindromeIterative(teststring);
    ...
    public double runRecursiveFunction(String teststring){
        ...
        long startTime = System.nanoTime();
        boolean ergRecursive = PalindromeRecursive.isPalindromeRecursive(teststring);
        long endTime = System.nanoTime();
        double actualTimeInSeconds = (endTime - startTime) * Math.pow(10, -9);
        ...
        writeFile(file,
            ("SWS" + "   |   " +
                ...
                Double.toString(Math.max(   runIterativeFunction("SWS"),
                        runRecursiveFunction("SWSe")
                    ) - 
                    Math.min(   runIterativeFunction("SWSe"), 
                        runRecursiveFunction("SWSe"))) + "   |   "));
